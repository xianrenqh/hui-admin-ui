...
layui.define(['hui-util'], function (exports) {
    ...
    var theme = {
        ...
        setColor: function (color, lightColor) {
            ...
            // 1. 应用所有派生 CSS 变量到主文档
            this._applyColorVars(document, color, lightColor);
            ...
            try {
                ...
                for (var i = 0; i < iframes.length; i++) {
                    try {
                        ...
                        if (win && win.document) {
                            if (method === 'setColor') {
                                // 复用 _applyColorVars 同步所有派生变量到 iframe
                                self._applyColorVars(win.document, value);
